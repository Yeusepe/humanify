...
- scan routes now keep long-running member scans Postgres-first and durability-honest:
  ...
  - the API does not pretend the Discord walk already happened; the Temporal worker owns the later scan execution, report opening, and moderator-warning refresh path
