...
export const requiredDirectories = [
  ...
  "packages\\queue",
  "packages\\telemetry",
  "packages\\verification-providers",
  "packages\\ui",
  "crates",
...
export const requiredFiles = [
  ...
  "apps\\scan-worker-temporal\\package.json",
  "apps\\scan-worker-temporal\\src\\index.ts",
  ...
  "packages\\verification-providers\\package.json",
  "packages\\verification-providers\\src\\index.ts",
